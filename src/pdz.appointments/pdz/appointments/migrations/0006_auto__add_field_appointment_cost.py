...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Appointment.cost'
        db.add_column(u'appointments_appointment', 'cost',
                      self.gf('django.db.models.fields.DecimalField')(default=1.0, max_digits=6, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Appointment.cost'
        db.delete_column(u'appointments_appointment', 'cost')
