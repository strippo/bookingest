...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Appointment.total_minutes'
        db.alter_column(u'appointments_appointment', 'total_minutes', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Appointment.total_minutes'
        db.alter_column(u'appointments_appointment', 'total_minutes', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        u'appointments.appointment': {
            ...
            'total_minutes': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
