...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Appointment.total_minutes'
        db.add_column(u'appointments_appointment', 'total_minutes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Appointment.total_minutes'
        db.delete_column(u'appointments_appointment', 'total_minutes')
