...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductMovement.movement_type'
        db.alter_column(u'warehouse_productmovement', 'movement_type', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ProductMovement.movement_type'
        db.alter_column(u'warehouse_productmovement', 'movement_type', self.gf('django.db.models.fields.IntegerField')(default=1))
    ...
    models = {
        ...
        u'warehouse.productmovement': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'movement_type': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
