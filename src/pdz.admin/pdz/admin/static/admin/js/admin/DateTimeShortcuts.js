...
var DateTimeShortcuts = {
    ...
    addClock: function(inp) {
        ...
        quickElement('i', clock_link, '', 'class', 'glyphicon glyphicon-time', 'alt', gettext('Clock'));
    ...
    openClock: function(num) {
        ...
        if (getStyle(document.body,'direction')!='rtl') {
            clock_box.style.left = findPosX(clock_link) -400 + 'px';
        }
        else {
    ...
    addCalendar: function(inp) {
        ...
        quickElement('i', cal_link, '', 'class', 'glyphicon glyphicon-calendar', 'alt', gettext('Calendar'));
        shortcuts_span.appendChild(document.createTextNode('\240'));
        shortcuts_span.appendChild(today_link);
        // FIX: DO NOT RENDER CALENDAR SHORTCUT ON CHANGE_FORM FIELDS (ONLY IN INLINES), USING JQUERY UI DATEPICKER!
        if ($(shortcuts_span).parents('.inline-related').length) {
            shortcuts_span.appendChild(document.createTextNode('\240|\240'));
        ...
        cal_nav_prev.innerHTML = '<i class="glyphicon glyphicon-chevron-left"></i>';
        var cal_nav_next = quickElement('a', cal_nav, '', 'href', 'javascript:DateTimeShortcuts.drawNext('+num+');');
        cal_nav_next.className = 'calendarnav-next pull-right';
        cal_nav_next.innerHTML = '<i class="glyphicon glyphicon-chevron-right"></i>';
